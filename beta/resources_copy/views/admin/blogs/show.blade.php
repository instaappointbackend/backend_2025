                            ...
                            @if($blog->attachment)
                                @if($blog->attachment_type == 'image')
                                    <div class="text-center">
                                        <img src="{{ asset('storage/' . $blog->attachment) }}" alt="{{ $blog->title }}" class="img-fluid rounded mb-2">
                                        <div class="mt-2">
                                            <a href="{{ asset('storage/' . $blog->attachment) }}" class="btn btn-sm btn-outline-primary" target="_blank">
                                ...
                                @elseif($blog->attachment_type == 'video')
                                    <div class="text-center">
                                        ...
                                        <div class="mt-2">
                                            <a href="{{ asset('storage/' . $blog->attachment) }}" class="btn btn-sm btn-outline-primary" download>
