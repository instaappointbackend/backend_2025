...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0"><br><br>
                    ...
                    <p class="lead mb-4">InstaAppoint helps you schedule appointments instantly without the hassle. Book, manage, and receive reminders all in one place.</p>
                ...
                <div class="col-lg-6 text-center">
                    <img src="{{ asset('images/dark_logo.png') }}" alt="InstaAppoint Logo" class="img-fluid logo" width="400">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="text-center p-4">
                        ...
                        <p class="text-muted">Book appointments with just a few taps. No more waiting on phone calls or emails.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="text-center p-4">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2 mb-5 mb-lg-0">
                    <img src="{{ asset('images/app_sceenshot.jpg') }}" alt="App Screenshot" class="img-fluid mx-auto d-block phone-mockup shadow" style="border-radius:10px">
                </div>
                <div class="col-lg-6 order-lg-1">
                    <h2 class="fw-bold mb-4">Designed for Effortless Experience</h2>
                    <p class="mb-4">InstaAppoint is crafted with user experience in mind, making appointment booking a breeze for everyone. Our intuitive interface ensures that you can navigate the app easily and book appointments without any technical knowledge.</p>
                    <div class="d-flex flex-column gap-3">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <p class="text-muted">Clean and intuitive design that anyone can use without confusion.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-start">
                            <div class="bg-primary text-white rounded-circle p-2 me-3 mt-1">
                            ...
                            <div>
                                <h5 class="fw-bold">Personalized Experience</h5>
                                <p class="text-muted">The app learns your preferences and suggests appointments accordingly.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-start">
                            <div class="bg-primary text-white rounded-circle p-2 me-3 mt-1">
                            ...
                            <div>
                                <h5 class="fw-bold">Multi-platform Support</h5>
                                <p class="text-muted">Available on both iOS and Android devices to serve all users.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="newsletter-card">
                            <div class="card-body p-4">
                                @include('partials.newsletter-form', ['source' => 'homepage'])
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Download Section -->
    <section class="py-5 my-5" id="download">
        <div class="container">
            <div class="text-center mb-5">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-6 col-lg-6 text-center mb-4 mb-md-0">
                    <div class="d-flex flex-column align-items-center">
                        <img src="{{ asset('images/ios.jpg') }}" alt="App Store QR Code" class="qr-code mb-3">
                        <h5 class="fw-bold">iOS App Store</h5>
                        <p class="text-muted mb-3">Scan to download for iPhone & iPad</p>
                        <a href="https://apps.apple.com/in/app/instaappoint/id6747049926" class="d-inline-block" target="_blank">
                            <img src="{{ asset('images/Download_on_the_App_Store_Badge.svg') }}" alt="Download on App Store" class="download-badge">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6 text-center">
                    <div class="d-flex flex-column align-items-center">
                        <img src="{{ asset('images/android.jpg') }}" alt="Google Play QR Code" class="qr-code mb-3">
                        <h5 class="fw-bold">Google Play Store</h5>
                        <p class="text-muted mb-3">Scan to download for Android devices</p>
                        <a href="https://play.google.com/store/apps/details?id=in.instaappoint.app&pcampaignid=web_share"  target="_blank" class="d-inline-block">
                            <img src="{{ asset('images/Google_Play_Store_badge_EN.svg') }}" alt="Get it on Google Play" class="download-badge">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0">"InstaAppoint has completely transformed how I manage my appointments. The interface is intuitive, and booking is incredibly fast. Highly recommended!"</p>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0">"The reminder feature is a lifesaver! I never miss appointments anymore, and rescheduling is so easy. Great app that truly delivers on its promise."</p>
                        </div>
                        <div class="card-footer bg-white border-0 pb-4 px-4">
                            <div class="d-flex align-items-center">
                                <div class="bg-primary rounded-circle text-white d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0">"As someone who manages multiple appointments weekly, InstaAppoint has been a game-changer. The ability to see real-time availability is incredibly useful."</p>
                        </div>
                        <div class="card-footer bg-white border-0 pb-4 px-4">
                            <div class="d-flex align-items-center">
                                <div class="bg-primary rounded-circle text-white d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <p class="mb-4">Have questions or feedback? We'd love to hear from you. Reach out to our team using the contact form or the information provided.</p>
                    <div class="mb-4">
                    ...
                    <div class="d-flex">
                        <a href="{{ $contactInfo['social_facebook'] ? $contactInfo['social_facebook'] : '#' }}" class="social-icon me-2">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="{{ $contactInfo['social_twitter'] ? $contactInfo['social_twitter'] : '#' }}" class="social-icon me-2">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="{{ $contactInfo['social_instagram'] ? $contactInfo['social_instagram'] : '#' }}" class="social-icon me-2">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a href="{{ $contactInfo['social_linkedin'] ? $contactInfo['social_linkedin'] : '#' }}" class="social-icon">
