...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <form action="{{ route('admin.users.deleted.customers') }}" method="GET" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-1">
                            <a href="{{ route('admin.users.deleted.customers') }}" class="btn btn-secondary ml-2">
                        ...
                        <tbody>
                            @forelse($customers as $index=>$customer)
                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        @if (isset($customer->data->clientAppointments))
                                            {{ $customer->data->clientAppointments->count() }}
                                        @else
                                            0
                                        @endif
                                    </td> --}}
