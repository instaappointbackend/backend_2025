                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                @if ($service->user && $service->user->profile_picture)
                                    <img src="{{ asset('storage/' . $service->user->profile_picture) }}"
                                        alt="{{ $service->user->name }}" class="rounded-circle me-2" width="40"
                                        height="40">
                                @else
                                ...
                                <div>
                                    <p class="mb-0 fw-bold">
                                        @if ($service->user)
                                            <a
                                                href="{{ route('admin.users.show', $service->user->id) }}">{{ $service->user->name }}</a>
                                        @else
                                            Unknown Vendor
                                        @endif
                                    </p>
                        ...
                        <div class="col-md-6">
                            ...
                            <p>{{ $service->user && $service->user->businessCategory ? $service->user->businessCategory->name : 'N/A' }}
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="card-body text-center">
                            ...
                            @if ($service->image)
                                <img src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->name }}"
                                    class="img-fluid rounded shadow-sm mb-3" style="max-height: 250px; object-fit: cover;">
                            @else
                                <div class="p-4 bg-light text-muted rounded">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar" role="progressbar"
                                style="width: {{ isset($stats['total_bookings']) && $stats['total_bookings'] > 0 ? '100' : '0' }}%">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar bg-success" role="progressbar"
                                style="width: {{ isset($stats['total_bookings']) && $stats['total_bookings'] > 0 ? ($stats['completed_bookings'] / $stats['total_bookings']) * 100 : '0' }}%">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar bg-danger" role="progressbar"
                                style="width: {{ isset($stats['total_bookings']) && $stats['total_bookings'] > 0 ? ($stats['cancelled_bookings'] / $stats['total_bookings']) * 100 : '0' }}%">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            @if (isset($stats['total_revenue']))
                                <span
                                    class="badge bg-success">₹{{ number_format($stats['total_revenue'] ?? 0, 2) }}</span>
                            @else
                                <span class="badge bg-secondary">N/A</span>
                            @endif
                        </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <form action="{{ route('admin.services.update', $service->id) }}" method="POST"
                            ...
                            <button type="submit"
                                class="btn btn-{{ $service->is_active ? 'warning' : 'success' }} w-100">
    ...
    @if (isset($recent_bookings) && count($recent_bookings) > 0)
        <div class="card mt-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.appointments.index', ['service_id' => $service->id]) }}"
                        ...
                        <tbody>
                            @foreach ($recent_bookings as $booking)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.appointments.show', $booking->id) }}"
