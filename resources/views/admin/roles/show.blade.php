                                            ...
                                            @foreach($permissions as $permission)
                                                <div class="mb-2">
                                                    ...
                                                    @if($permission->description)
                                                        <br><small class="text-muted ml-3">{{ $permission->description }}</small>
                                                    @endif
                                                </div>
                                            @endforeach
                                        </div>
            ...
            <div class="card">
                ...
                @if(!$role->is_system)
                    <div class="card-footer">
                        <button type="button" class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#assignUsersModal">
