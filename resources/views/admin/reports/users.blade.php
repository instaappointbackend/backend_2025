...
<a href="{{ route('admin.reports.users.export') }}?start_date={{ request('start_date') }}&end_date={{ request('end_date') }}&role={{ request('role') }}" class="btn btn-success me-2">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <div class="me-2">
                                <img src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('admin/images/default-avatar.png') }}" alt="{{ $user->name }}" class="avatar-img" width="30" height="30">
                            </div>
                            <div>{{ $user->name }}</div>
                        </div>
                    </td>
