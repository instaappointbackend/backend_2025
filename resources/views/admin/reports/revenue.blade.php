...
<a href="{{ route('admin.reports.revenue.export') }}?start_date={{ request('start_date') }}&end_date={{ request('end_date') }}&status={{ request('status') }}" class="btn btn-success me-2">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                @empty
                <tr>
                    <td colspan="10" class="text-center">No payment transactions found in the selected date range.</td>
                </tr>
                @endforelse
                </tbody>
            </table>
