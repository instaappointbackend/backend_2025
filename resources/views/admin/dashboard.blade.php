...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 mb-4">
            <a href="{{ route('admin.users.index') }}" class="stat-card position-relative bg-white text-decoration-none" data-card="users">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <a href="{{ route('admin.users.vendors') }}" class="stat-card position-relative bg-white text-decoration-none" data-card="vendors">
            <div class="stat-card position-relative bg-white">
                <div class="stat-card-body">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <a href="{{ route('admin.appointments.index') }}" class="stat-card position-relative bg-white text-decoration-none" data-card="appointments">
            <div class="stat-card position-relative bg-white">
                <div class="stat-card-body">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <a href="{{ route('admin.services.index') }}" class="stat-card position-relative bg-white text-decoration-none" data-card="services">
            <div class="stat-card position-relative bg-white">
                <div class="stat-card-body">
...
<div class="row">
    <div class="col-md-3 col-sm-6 mb-4">
        <a href="{{ route('admin.appointments.index', ['status' => 'pending']) }}" class="card dashboard-card stat-status-card h-100 text-decoration-none" data-card="pending">
            <div class="card-body">
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <a href="{{ route('admin.appointments.index', ['status' => 'confirmed']) }}" class="card dashboard-card stat-status-card h-100 text-decoration-none" data-card="confirmed">
            <div class="card-body">
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <a href="{{ route('admin.appointments.index', ['status' => 'completed']) }}" class="card dashboard-card stat-status-card h-100 text-decoration-none" data-card="completed">
            <div class="card-body">
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <a href="{{ route('admin.appointments.index', ['status' => 'cancelled']) }}" class="card dashboard-card stat-status-card h-100 text-decoration-none" data-card="cancelled">
            <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <a href="{{ route('admin.refunds.index') }}" class="card dashboard-card stat-status-card h-100 text-decoration-none" data-card="total-refunds">
                <div class="card-body">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <a href="{{ route('admin.refunds.index', ['status' => 'pending']) }}" class="card dashboard-card stat-status-card h-100 text-decoration-none" data-card="pending-refunds">
                <div class="card-body">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card dashboard-card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="dropdownAppointmentStats" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-calendar-alt me-1"></i> Last 7 Days
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownAppointmentStats">
                            <li><a class="dropdown-item" href="#"><i class="fas fa-calendar-week me-2"></i>Last 7 Days</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fas fa-calendar-alt me-2"></i>Last 30 Days</a></li>
                            <li><a class="dropdown-item" href="#"><i class="far fa-calendar-alt me-2"></i>Last 90 Days</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                @forelse($recentAppointments as $appointment)
                                    <tr>
                                        ...
                                        <td class="text-end pe-3">
                                            <a href="{{ route('admin.appointments.show', $appointment->id) }}" class="btn-action btn-info text-white">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-4">
                                            <img src="{{ asset('images/no-data.svg') }}" alt="No Data" style="height: 120px; opacity: 0.5;">
                ...
                <div class="card-body p-0">
                    @forelse($recentRefunds ?? [] as $refund)
                        <div class="d-flex align-items-center p-3 border-bottom">
                            <div class="activity-icon bg-{{ $refund->refund_status == 'pending' ? 'warning' : ($refund->refund_status == 'processed' ? 'success' : 'danger') }} me-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">{{ $refund->created_at->diffForHumans() }}</p>
                                    </div>
                                    <div class="text-end">
                                        <div class="fw-bold text-success">₹{{ number_format($refund->refund_amount, 0) }}</div>
                                        <span class="badge badge-{{ $refund->refund_status == 'pending' ? 'warning' : ($refund->refund_status == 'processed' ? 'success' : 'danger') }} small">
