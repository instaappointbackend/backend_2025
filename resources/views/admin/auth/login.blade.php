        ...
        <div class="auth-card">
            ...
            <div class="auth-body">
                ...
                <form method="POST" action="{{ route('admin.send.otp') }}">
                    ...
                    <div class="mb-3">
                        <label for="login_field" class="form-label">Mobile Number</label>
                        <input type="text" class="form-control @error('login_field') is-invalid @enderror"
                            id="login_field" name="login_field" value="{{ old('login_field') }}"
                            placeholder="Enter your email or mobile number" required autofocus>
                        @error('login_field')
