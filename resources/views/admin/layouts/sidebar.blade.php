<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-user">
        <div class="user-image">
            <img src="{{ Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : asset('admin/images/default-avatar.png') }}"
                alt="Admin">
        </div>
        <div class="user-info">
    ...
    <ul class="sidebar-menu">
        ...
        @if (hasPermission('kyc_view_kyc_submissions'))
            <li class="menu-item {{ request()->routeIs('admin.kyc*') ? 'active' : '' }}">
                <a href="{{ route('admin.kyc.index') }}">
                    ...
                    @php
                        $pendingKyc = \App\Models\User::where('is_kyc_completed', false)
        ...
        @if (hasPermission('roles_view_roles') || hasPermission('permissions_view_permissions'))
            ...
            <li
                class="menu-item has-submenu {{ request()->routeIs('admin.roles*') || request()->routeIs('admin.permissions*') ? 'active open' : '' }}">
                <a href="#" class="submenu-toggle">
                ...
                <ul class="submenu">
                    @if (hasPermission('roles_view_roles'))
                        <li
                            class="{{ request()->routeIs('admin.roles.index') || request()->routeIs('admin.roles.show') || request()->routeIs('admin.roles.edit') ? 'active' : '' }}">
...
@endif-->
        ...
        @if (hasPermission('content_manage_blogs') ||
                ...
                hasPermission('content_manage_pages'))
        ...
        @if (hasPermission('content_manage_web_blogs'))
            <li class="menu-item {{ request()->routeIs('admin.web-blogs*') ? 'active' : '' }}">
        ...
        @if (hasPermission('reports_view_reports'))
            ...
            <li
                class="menu-item has-submenu {{ (request()->routeIs('admin.reports.appointments') || request()->routeIs('admin.reports.users') || request()->routeIs('admin.reports.revenue') || request()->routeIs('admin.reports.payouts')) && !request()->routeIs('admin.reports.index') ? 'active open' : '' }}">
                <a href="#" class="submenu-toggle">
