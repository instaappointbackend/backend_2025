                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($payment->user)
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ $payment->user->profile_picture ? asset('storage/' . $payment->user->profile_picture) : asset('admin/images/default-avatar.png') }}"
                                                    alt="{{ $payment->user->name }}" class="avatar-img" width="30"
                                                    height="30">
                                            </div>
                                ...
                                <td>
                                    @if ($payment->provider)
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ $payment->provider->profile_picture ? asset('storage/' . $payment->provider->profile_picture) : asset('admin/images/default-avatar.png') }}"
                                                    alt="{{ $payment->provider->name }}" class="avatar-img"
                                                    width="30" height="30">
                                            </div>
