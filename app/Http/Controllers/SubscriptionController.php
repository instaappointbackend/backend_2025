...
class SubscriptionController extends Controller
{
    ...
    public function subscribe(Request $request)
    {
        ...
        try {
            ...
            if ($paymentResponse['success']) {
                ...
                $subscription->phonepe_transaction_id = $transactionId;
    ...
    public function callback(Request $request)
    {
        ...
        $result = Subscription::with('user')->where('phonepe_transaction_id', $transactionId)->first();
        ...
        if (!$transactionId) {
            ...
            return redirect()->route('subscribe.status', ['status' => 'success', 'message' => "Invalid transaction ID"]);
        }
        ...
        if (!$result) {
            ...
            return redirect()->route('subscribe.status', ['status' => 'success', 'message' => "Subscription not found"]);
        }
        ...
        try {
            ...
            if ($isSuccessful && $isCompleted) {
                ...
                return redirect()->route('subscribe.status', ['status' => 'success']);
            }
            ...
            return redirect()->route('subscribe.status', ['status' => 'failed', 'message' => $message]);
            ...
            return redirect()->route('subscribe.status', ['status' => 'success', 'message' => 'An unexpected error occurred while processing your payment. Please contact support']);
        }
    }
